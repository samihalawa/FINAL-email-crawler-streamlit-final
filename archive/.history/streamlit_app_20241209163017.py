...
def main():
    st.set_page_config(page_title="Autoclient.ai | Lead Generation AI App", layout="wide")
    st.title("Autoclient.ai - Automated Lead Generation")
    
    # Sidebar navigation
    with st.sidebar:
        selected = option_menu("Navigation", ["Manual Search", "Bulk Send", "View Leads", "Email Templates", "Projects & Campaigns", "Knowledge Base", "Settings"])
